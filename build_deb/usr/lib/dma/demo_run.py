...
os.system("python3 ~/automation_project/scripts/analyze_engagement.py")
time.sleep(1)

# Step 2: Generate visual report
logger.info("🎨 Generating visual PDF report...")
os.system("python3 ~/automation_project/scripts/generate_visual_report.py")
time.sleep(1)

# Step 3: Run CLI dashboard
logger.info("📈 Displaying mini CLI dashboard (press Ctrl+C to exit)...")
time.sleep(1)
os.system("python3 ~/automation_project/scripts/cli_dashboard.py")
